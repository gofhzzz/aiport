...
const LockIcon: React.FC<Props> = ({ className }) => {
  return (
    <svg viewBox="0 0 508 508" className={className}>
      <circle fill="#FFD15C" cx="253.55" cy="201.7" r="201.7" />
      <g>
        <path
          fill="#40596B"
      ...
      <circle fill="#F8B64C" cx="253.55" cy="201.7" r="146.2" />
      <path
        fill="#FFFFFF"
        d="M353.75,185.9c4.5-4.4,2-12.1-4.2-13l-57.7-8.4c-2.5-0.4-4.6-1.9-5.7-4.2l-25.8-52.3
