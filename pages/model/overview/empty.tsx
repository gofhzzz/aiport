      ...
      <div className="py-4 mt-10 shadow-lg rounded-md mb-8">
        <div className="justify-around flex text-md font-semibold">
          ...
          <div className="flex-grow pl-4">
            <p className="pb-4">
              Created Time: {formatDate(String(model.created))}
            </p>
...
const Sidebar = (
  <div className="py-4 flex flex-col">
    <h2 className="px-4 font-semibold text-xl">Mask R-CNN</h2>
...
ModelOverviewEmptyPage.Layout = Dashboard;
ModelOverviewEmptyPage.Sidebar = Sidebar;
export default ModelOverviewEmptyPage;
