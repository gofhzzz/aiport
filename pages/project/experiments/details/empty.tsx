...
const srcList = [
  '/images/visualization/empty/1.png',
  '/images/visualization/empty/2.png',
  '/images/visualization/empty/3.png',
  '/images/visualization/empty/4.png',
  '/images/visualization/empty/5.png',
  '/images/visualization/empty/6.png',
  '/images/visualization/empty/7.png',
];
          ...
          <div className="py-4 mt-10 max-w-7xl mx-auto shadow-lg rounded-md">
            <div className="justify-around flex text-md font-semibold">
              <div className="text-left pl-4 flex-grow">
                <p className="pb-4">
                  Start Time: <span className="font-normal">-</span>
                </p>
                <p>
                  Last Run Time: <span className="font-normal">{'-'}</span>
                </p>
              </div>
              ...
              <div className="flex-grow pl-4">
                ...
                <p>
                  Image:{' '}
                  <span className="font-normal">nvidia-pytorch-1.8.1</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="py-4 mt-10 max-w-7xl mx-auto shadow-lg rounded-md">
            ...
            <div className="justify-around flex text-md font-semibold">
              ...
              <div className="flex-grow pl-4">
                ...
                <p>
                  Epoch: <span className="font-normal">0/50</span>
                </p>
              </div>
            </div>
          </div>
